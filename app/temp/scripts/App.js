...
var Modal = function () {
  function Modal() {
    ...
    this.modalClosebtn = (0, _jquery2.default)(".modal__closebtn");
    this.modalContainer = (0, _jquery2.default)(".modal");
    this.contactBtn = (0, _jquery2.default)(".btn");
    this.event();
  }
    ...
    value: function createPageSectionWaypoints() {
      ...
      this.pageSections.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              var matchinhHeaderLink = currentPageSection.getAttribute("data-matching-link");
              that.headerLinks.removeClass("is-current-link");
              (0, _jquery2.default)(matchinhHeaderLink).addClass("is-current-link");
            }
          },
          offset: "18%"
        });
...
var revealOnScroll = new _revealOnScroll2.default((0, _jquery2.default)(".testimonial"), "65%");
var revealOnScroll = new _revealOnScroll2.default((0, _jquery2.default)(".generic-content-container"), "65%");
